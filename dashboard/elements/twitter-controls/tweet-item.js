var acceptedTweetsRep = nodecg.Replicant('acceptedTweets', {defaultValue: []});
var acceptedTweets = [];
...
class TweetItem extends Polymer.Element {
	...
	accept() {
		console.log(`twitter: New tweet added to approved list: ${this.value.screen_name} - ${this.value.text}`)
